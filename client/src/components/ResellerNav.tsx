...
import { LogOut, CircleDollarSign, Menu, X } from "lucide-react";
        ...
        <div className="flex justify-between h-16">
          ...
          <div className="hidden md:flex items-center">
            <div className="flex items-center space-x-4">
              <div className="flex items-center bg-gray-800 px-3 py-1 rounded-full border border-primary/20">
                <CircleDollarSign className="h-5 w-5 text-primary mr-2" />
                <span className="text-gray-200 font-medium">Credits: {user?.credits || 0}</span>
              </div>
          ...
          <div className="flex items-center md:hidden">
            <div className="flex items-center mr-2 bg-gray-800 px-2 py-1 rounded-full border border-primary/20">
              <CircleDollarSign className="h-4 w-4 text-primary mr-1" />
              <span className="text-gray-200 text-sm">{user?.credits || 0}</span>
            </div>
            <button
              type="button"
